  ...
  _html() {
    ...
    <div class="social-app">
      ...
      <div class="social-links">
        <a class="social-card" href="https://github.com/ragdolcat" target="_blank" rel="noopener">
          ...
          <div class="social-card-info">
            ...
            <div class="social-card-handle">@ragdolcat</div>
          </div>
          <div class="social-card-arrow">→</div>
        </a>

        <a class="social-card" href="https://www.linkedin.com/in/mesrine-nolane" target="_blank" rel="noopener">
        ...
        <a class="social-card" href="mailto:nolane.mesrine.pro@email.com">
          ...
          <div class="social-card-info">
            ...
            <div class="social-card-handle">nolane.mesrine.pro@email.com</div>
          </div>
          <div class="social-card-arrow">→</div>
        </a>
      </div>
